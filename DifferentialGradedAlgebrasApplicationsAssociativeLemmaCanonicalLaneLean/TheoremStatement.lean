import DifferentialGradedAlgebrasApplicationsAssociativeLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "differential-graded-algebras associative lemma certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
